...
const CORE=['./','./index.html','./login.html','./account.html','./releases.html','./styles.css','./app.js','./auth.js','./extra-content.js','./link-fix.js','./email-config.js','./manifest.webmanifest','./LOGIN.md','./EMAIL-SETUP.md'];
