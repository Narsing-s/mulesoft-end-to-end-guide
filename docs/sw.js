const CACHE='mulejourney-v13';
const CORE=['./','./index.html','./login.html','./account.html','./releases.html','./email-test.html','./styles.css','./app.js','./auth.js','./account-controls.js','./extra-content.js','./link-fix.js','./email-config.js','./manifest.webmanifest','./LOGIN.md','./EMAIL-SETUP.md'];
