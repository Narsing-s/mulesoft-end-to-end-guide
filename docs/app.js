...
['16','Continuous Engineering','Advanced','After the capstone, increase scale, failure, security, availability and architecture complexity. There is no final end.','../53-End-to-End-Study-Path/README.md']
];
...
['10','Banking Capstone','Advanced','Connect Experience → Process → System APIs with DB/MQ and operational controls.','../17-Real-World-Project/README.md']
];
...
const commands=[['Start-to-End Study Path','../53-End-to-End-Study-Path/README.md'],['Learning Assessment','../55-Learning-Assessment-and-Project-Ladder/README.md'],['Modern Platform Deep Dive','../56-Modern-Platform-Deep-Dive/README.md'],['Start Here','../00-START-HERE.md'],['Roadmap','#roadmap'],['Topic Library','#topics'],['Hands-on Labs','#labs'],['Banking Capstone','#capstone'],['Security','../24-Security/README.md'],['MUnit','../25-MUnit/README.md'],['Troubleshooting','../26-Troubleshooting/README.md'],['Architecture','../22-Patterns-And-Architecture/README.md'],['Cheat Sheet','../28-Glossary-And-Cheat-Sheets/MULE-4-CHEAT-SHEET.md']];
