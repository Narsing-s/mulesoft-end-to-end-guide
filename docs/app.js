...
['18','DataWeave Mastery','Advanced','Progress from selectors and core operators to reusable functions, complex transformations, performance and production-grade testing.','../59-DataWeave-Mastery/README.md'],
['19','Production Support Engineering','Advanced','Operate real MuleSoft integrations: incident triage, logs, correlation IDs, dependencies, recovery, RCA and handover.','../60-Production-Support-Engineering/README.md'],
['20','Continuous Engineering','Advanced','After the capstone, increase scale, failure, security, availability and architecture complexity. There is no final end.','../53-End-to-End-Study-Path/README.md']
];
...
['DataWeave Mastery','Easy → advanced transformations, reusable functions, edge cases, performance, debugging and production patterns.','../59-DataWeave-Mastery/README.md','build'],
['Production Support Engineering','Incident triage, Runtime Manager investigation, dependency analysis, safe recovery, RCA and shift handover.','../60-Production-Support-Engineering/README.md','operate'],
...
['12','DataWeave Transformation Lab','Advanced','Solve a transformation from exact input and expected output, then add null, empty, type and performance edge cases.','../59-DataWeave-Mastery/README.md'],
['13','Production Incident Drill','Advanced','Triage an integration incident using correlation IDs, logs, dependency checks, safe recovery and RCA.','../60-Production-Support-Engineering/README.md'],
['14','Banking Capstone','Advanced','Connect Experience → Process → System APIs with DB/MQ and operational controls.','../17-Real-World-Project/README.md']
];
...
const commands=[['Start-to-End Study Path','../53-End-to-End-Study-Path/README.md'],['Learning Assessment','../55-Learning-Assessment-and-Project-Ladder/README.md'],['Modern Platform Deep Dive','../56-Modern-Platform-Deep-Dive/README.md'],['API Contracts & Protocols','../57-API-Contracts-and-Protocols/README.md'],['Quality Engineering','../58-Quality-Engineering/README.md'],['DataWeave Mastery','../59-DataWeave-Mastery/README.md'],['Production Support Engineering','../60-Production-Support-Engineering/README.md'],['Start Here','../00-START-HERE.md'],['Roadmap','#roadmap'],['Topic Library','#topics'],['Hands-on Labs','#labs'],['Interview Mode','#interview'],['Banking Capstone','#capstone'],['Security','../24-Security/README.md'],['MUnit','../25-MUnit/README.md'],['Troubleshooting','../26-Troubleshooting/README.md'],['Architecture','../22-Patterns-And-Architecture/README.md'],['Cheat Sheet','../28-Glossary-And-Cheat-Sheets/MULE-4-CHEAT-SHEET.md']];
