...
- Mule Runtime and Mule Event
- HTTP and REST
- DataWeave from beginner to advanced
- RAML/OAS and APIkit
- API-led connectivity
- Connectors and Studio components
- Choice, Scatter-Gather, For Each, Parallel For Each and Batch
- Retry, timeout, reconnection and idempotency
- Error handling and recovery
- Database, File, SFTP, JMS, IBM MQ, Anypoint MQ and Kafka
- Salesforce and enterprise integrations
- SOAP and API integration
- Security, TLS, OAuth, JWT and secure properties
- MUnit and quality engineering
- Maven, Git and CI/CD
- CloudHub, CloudHub 2.0, Runtime Fabric and deployment concepts
- Observability, performance and production support
- Architecture and design patterns
- Banking capstone projects
...
API-Led Connectivity
   ↓
Errors + Connectors + Integration Patterns
   ↓
Security + Testing
   ↓
Deployment + CI/CD
...
Observability + Performance
   ↓
Architecture + Production Support
   ↓
Hands-on Challenges
   ↓
Banking Capstone
...
What → Why → When → Architecture → Configuration
       ...
       Security / Performance / Testing
                    ↓
       Troubleshooting / Production Runbook
                    ↓
            Interview Q&A / Lab
```
...
- `01-Fundamentals` — Mule fundamentals
- `03-DataWeave` — DataWeave learning and practice
- `04-API-Development` — API contracts and implementation
- `07-Connectors` — connector and Studio mastery
- `12-Testing` / `25-MUnit` — testing
